...
func (_m *MockPatientDataUseCase) GetData(args GetDataArgs) (*bytes.Buffer, *common.DetailedError) {
	ret := _m.Called(args)

	var r0 *bytes.Buffer
	if rf, ok := ret.Get(0).(func(GetDataArgs) *bytes.Buffer); ok {
		r0 = rf(args)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(GetDataArgs) *common.DetailedError); ok {
		r1 = rf(args)
	} else {
		if ret.Get(1) != nil {
